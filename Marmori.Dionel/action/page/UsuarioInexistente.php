...
<html lang="es">
  <head>
    ...
    <title>Usu. Inex - Marmori Est.</title>
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="/Marmori/Registro.php">Registrarse<span class="sr-only">(current)</span></a>
          </ul>
        </div>
      </nav>
    </header>
    ...
    <main role="main" class="container">
      ...
      <p><a href="/Marmori/login.php">Reintentar</a></p>
    </main>
