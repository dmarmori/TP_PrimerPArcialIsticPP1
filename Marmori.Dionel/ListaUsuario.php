    ...
    <main role="main" class="container">
      ...
      <ol>  
       <?php 
        ...
        $archivoUsuarios = fopen("action/usuarios.txt", "r") or die("Imposible arbrir el archivo");
        while(!feof($archivoUsuarios)) 
        {
            $objetoUsuarios = json_decode(fgets($archivoUsuarios));
            if (!$objetoUsuarios=="")
            {

            echo "<li>".$objetoUsuarios->Usuario."</li><br>";
            }
        } 
        ?>
      </ol>
