...
<html lang="es">
  ...
  $archivoListaFact = fopen("action/VehiculosFact.txt", "r") or die("Imposible arbrir el archivo");
  ...
  while(!feof($archivoListaFact)) 
  {
   ...
   echo "<td>".$PatenteFact
        ."------"
          ."</td><td>".date("Y-m-d h:i:sa",$HorarioIniFact)
          ."------"
          ."</td><td>".date("Y-m-d h:i:sa",$HorarioSalFact)
          ."------"
